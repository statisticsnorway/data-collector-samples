        ...
        CompletableFuture<ExecutionContext> future = Worker.newBuilder()
                .flow(Flow.start("Collect Sirius", "loop")
                        .configure(context()
                                ...
                                .variable("hentAntallMeldingOmGangen", "100")
                        ...
                        .node(get("part")
                                .url("${baseURL}/api/formueinntekt/skattemelding/utkast/hendelser/?fraSekvensnummer=${fromSequence}&antall=${hentAntallMeldingOmGangen}")
